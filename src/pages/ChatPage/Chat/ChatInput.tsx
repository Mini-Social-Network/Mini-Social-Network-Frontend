...
interface ChatInputProps {
  handleSendMessage: (msg: string, img: string) => any;
}
  ...
  return (
    <Container>
      <form className="input-container" onSubmit={(event) => sendChat(event)}>
        <input type="text" placeholder={t('mini.ibhere')} onChange={(e) => setMsg(e.target.value)} value={msg} />
      ...
      <div className="image-send">
        <ImageUploading multiple={false} value={images} onChange={onChange} onError={handleError}>
